    ...
    public class ParticipantsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Participant != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Participant'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ParticipantId,Name,Email,Phone")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParticipantId,Name,Email,Phone")] Participant participant)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Participant'  is null.");
            }
            var participant = await _context.Participant.FindAsync(id);
            if (participant != null)
            {
